package utils.exposed
{
   ...
   public class ExposedObjectManager
   {
      ...
      private var m_ReferenceableObjects:Dictionary = new Dictionary();
      
      private var m_ReferencesToResolve:Vector.<ExposedReference> = new Vector.<ExposedReference>();
      ...
      private function ResolveReferences() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               _loc4_ = this.FindReferenceableObject(_loc3_.referencedObjectId);
               if(_loc4_ == null)
               {
