package utils.exposed
{
   ...
   {
      private var m_Contents:Vector.<ExposedObject> = new Vector.<ExposedObject>();
      ...
      private function LoadContentsState(param1:XML, param2:String) : void
      {
         ...
         {
            _loc11_ = _loc8_.@id;
            _loc5_ = this.FindAndRemoveChildObject(_loc11_);
            if(_loc5_ != null)
            {
            ...
            {
               _loc6_ = getDefinitionByName(_loc8_.@type) as Class;
               if(_loc6_ != null)
               {
                  _loc5_ = new _loc6_();
                  _loc5_.id = _loc11_;
      ...
      private function SaveContentsState(param1:String) : XML
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc5_ = this.m_Contents[_loc4_].SaveState(param1);
            _loc5_.setName("object");
