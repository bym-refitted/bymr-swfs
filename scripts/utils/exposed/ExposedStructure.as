         ...
         for(_loc2_ in _loc1_)
         {
            if(this[_loc2_] != null)
            {
               ...
               else
               {
                  ...
                  _loc4_ = _loc3_.qualifiedClassName;
                  if(_loc4_.indexOf(VECTOR_TYPE_TEMPLATE_NAME) != -1)
                  {
      ...
      internal function LoadState(param1:XML, param2:String) : void
      {
         ...
         for each(propertyNode in a_State.property)
         {
            ...
            else
            {
               ...
               if(propertyType.indexOf(REFERENCE_TYPE_TEMPLATE_NAME) != -1)
               {
               ...
               {
                  if(elementType.indexOf(REFERENCE_TYPE_TEMPLATE_NAME) != -1)
                  {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            else
            {
               if(this[_loc5_] is ExposedObject)
               {
                  ...
                  _loc9_ = ExposedObjectManager.instance.FindReferenceableObject(_loc8_.id);
                  if(_loc9_ != null)
                  {
                     if(_loc8_ != _loc9_)
                     {
               ...
               {
                  _loc7_ = this[_loc5_].SaveState(param1);
                  _loc7_.setName("property");
                  _loc7_.@name = _loc5_;
                  _loc2_.appendChild(_loc7_);
               }
                     ...
                     else
                     {
                        ...
                        else if(this[_loc5_][0] is ExposedStructure)
                        {
                           ...
                           while(_loc11_ < _loc10_)
                           {
                              ...
                              {
                                 _loc12_ = this[_loc5_][_loc11_].SaveState(param1);
                                 _loc12_.setName("element");
                                 _loc12_.@index = _loc11_;
                                 _loc7_.appendChild(_loc12_);
                              }
                              _loc11_++;
