package
{
   ...
   public class INFERNO_EMERGENCE_POPUPS
   {
      ...
      public static function ShowDialogue(param1:int) : MovieClip
      {
         ...
         var _loc8_:MovieClip = POPUPS.DisplayDialogue(_loc4_,_loc5_,_loc6_,_loc2_,_loc3_,_loc7_);
         _loc8_.addEventListener(Event.REMOVED_FROM_STAGE,DialogueCB,false,0,true);
         return _loc8_;
      }
