package
{
   ...
   public class GUARDIANBUTTON extends GUARDIANBUTTON_CLIP
   {
      ...
      public function GUARDIANBUTTON(param1:String, param2:int)
      {
         super();
         this._creatureID = param1;
         this._creatureData = GUARDIANCAGE._guardians[param1];
         this._level = param2;
         var _loc3_:String = GUARDIANCAGE._guardians[param1].name;
         ...
         this._description.Setup(158,26,KEYS.Get(GUARDIANCAGE._guardians[this._creatureID].description),5);
