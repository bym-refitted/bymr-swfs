package
{
   ...
   public class GuardTower extends BTOWER implements ICoreBuilding
   {
      ...
      public static const k_SPECIAL_ANGLE:Point = new Point(90,3 * 60);
      ...
      {
         super();
         m_teslaPositions = Vector.<TeslaData>([new TeslaData(new Point(-0.5,-68),new Point(-180,0)),new TeslaData(new Point(58,-37),new Point(-90,90)),new TeslaData(new Point(-0.5,-7),new Point(0,3 * 60)),new TeslaData(new Point(-59,-40),k_SPECIAL_ANGLE)]);
         m_teslaDamagedPositions = Vector.<TeslaData>([new TeslaData(new Point(-0.5,-68),new Point(-180,0)),new TeslaData(new Point(58,-26),new Point(-90,90)),new TeslaData(new Point(-6,-7),new Point(0,3 * 60)),new TeslaData(new Point(-67,-53),k_SPECIAL_ANGLE)]);
