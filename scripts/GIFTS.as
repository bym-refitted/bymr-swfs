package
{
   ...
   public class GIFTS
   {
      ...
      public static function Show(param1:int, param2:int, param3:String, param4:int, param5:String, param6:int) : *
      {
         var img:String;
      ...
      public static function ShowSentGift(param1:int, param2:int, param3:String, param4:int, param5:String, param6:int) : *
      {
         var img:String;
         var LoadImageError:Function;
         var onImageLoaded:Function;
      ...
      public static function ShowSentInvite(param1:int, param2:int, param3:String, param4:int, param5:String, param6:int) : *
      {
         var img:String;
         var LoadImageError:Function;
         var onImageLoaded:Function;
      ...
      public static function Fund(param1:int, param2:int, param3:int) : *
      {
      ...
      public static function AddXP(param1:int, param2:uint) : void
      {
      ...
      public static function HelpFriend(param1:int) : *
      {
         var giftFromID:int = param1;
      ...
      public static function GiveThanks(param1:int, param2:int, param3:int) : *
      {
         var resourceID:int = param1;
         var giftFromID:int = param2;
