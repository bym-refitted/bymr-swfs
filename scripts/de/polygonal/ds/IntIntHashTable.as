   ...
   public class IntIntHashTable implements Map
   {
      ...
      public function toValSet() : Set
      {
         ...
         while(true)
         {
            ...
            _loc4_ = _loc2_++;
            _loc5_ = int(_data[_loc4_ * 3 + 1]);
            if(_loc5_ != -2147483648)
            {
               _loc6_ = _loc5_ * 73856093 & _loc1_._mask;
               _loc7_ = int(_loc1_._hash[_loc6_]);
               if(_loc7_ == -1)
               {
      ...
      public function toKeySet() : Set
      {
         ...
         while(true)
         {
            ...
            if(_loc5_ != -2147483648)
            {
               _loc6_ = int(_data[_loc4_ * 3]);
               _loc7_ = _loc6_ * 73856093 & _loc1_._mask;
               _loc8_ = int(_loc1_._hash[_loc7_]);
               if(_loc8_ == -1)
               {
                  if(_loc1_._size == _loc1_._capacity)
                  {
      ...
      public function setIfAbsent(param1:int, param2:int) : Boolean
      {
         ...
         var _loc4_:int = int(_hash[_loc3_]);
         if(_loc4_ == -1)
         {
            if(_size == _capacity)
            {
      ...
      public function class_1(param1:Object, param2:Object) : Boolean
      {
         var _loc8_:* = false;
         var _loc9_:int = 0;
         ...
         var _loc7_:int = int(_hash[_loc6_]);
         if(_loc7_ == -1)
         {
            _hash[_loc6_] = _loc5_;
            ++_size;
      ...
      public function remove(param1:Object) : Boolean
      {
         ...
         if(_loc3_ > 0)
         {
            ...
            while(_loc5_ < int(_loc4_.length))
            {
               ...
               _loc8_ = int(_hash[_loc7_]);
               if(_loc8_ != -1)
               {
                  if(_loc6_ == int(_data[_loc8_]))
                  {
      ...
      public function remap(param1:Object, param2:Object) : Boolean
      {
         var _loc3_:int = int(param1);
         var _loc4_:int = int(param2);
         var _loc5_:int = int(_hash[_loc3_ * 73856093 & _mask]);
         if(_loc5_ == -1)
         {
            return false;
         }
      ...
      public function rehash(param1:int) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            if(_loc6_ != -2147483648)
            {
               ...
               _loc10_ = int(_loc2_._hash[_loc9_]);
               if(_loc10_ == -1)
               {
      ...
      public function clone(param1:Boolean, param2:Object = undefined) : Collection
      {
         ...
         var _loc4_:IntIntHashTable = Instance.createEmpty(IntIntHashTable);
         _loc4_.key = _loc5_;
