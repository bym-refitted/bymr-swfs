package de.polygonal.ds
{
   ...
   public class SLL implements Collection
   {
      ...
      public function concat(param1:SLL) : SLL
      {
         ...
         {
            _loc4_ = _loc3_.val;
            _loc5_ = _loc2_._reservedSize == 0 || _loc2_._poolSize == 0 ? new SLLNode(_loc4_,_loc2_) : (_loc6_ = _loc2_._headPool, _loc2_._headPool = _loc2_._headPool.next, --_loc2_._poolSize, _loc6_.val = _loc4_, _loc6_.next = null, _loc6_);
            if(_loc2_.tail != null)
            {
         ...
         while(true)
         {
            ...
            while(_loc3_ != null)
            {
               ...
               while(_loc9_ > 0 || _loc10_ > 0 && _loc4_ != null)
               {
                  ...
                  else if(int(_loc3_.val.compare(_loc4_.val)) >= 0)
                  {
                     _loc5_ = _loc3_;
                     _loc3_ = _loc3_.next;
                     _loc9_--;
