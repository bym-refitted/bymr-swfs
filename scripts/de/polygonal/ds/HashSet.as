package de.polygonal.ds
{
   ...
   public class HashSet implements Set
   {
      ...
      public function HashSet(param1:int = 0, param2:int = -1, param3:Boolean = true, param4:int = -1)
      {
         ...
         _isResizable = param3;
         _h = new IntIntHashTable(param1,param2,_isResizable,param4);
         var _loc5_:Array;
      ...
      public function method_1(param1:Object) : Boolean
      {
         ...
         if(size() == _h._capacity)
         {
            ...
            _loc7_ = int(_loc3_._hash[_loc6_]);
            if(_loc7_ == -1)
            {
            ...
            if(§§pop())
            {
               _loc4_ = _h._capacity >> 1;
               _loc5_ = _h._capacity >> 1 << 1;
      ...
      {
         var _loc4_:* = null as IntIntHashTable;
         var _loc5_:* = 0;
         var _loc6_:* = 0;
         var _loc7_:int = 0;
         ...
         _loc6_ = int(_loc4_._hash[_loc5_ * 73856093 & _loc4_._mask]);
         if(_loc6_ == -1)
         {
            §§push(-2147483648);
         }
         ...
         _loc4_ = _h;
         _loc5_ = int(_loc2_.key);
         _loc6_ = _loc5_ * 73856093 & _loc4_._mask;
         _loc7_ = int(_loc4_._hash[_loc6_]);
         if(_loc7_ != -1)
         {
            if(_loc5_ == int(_loc4_._data[_loc7_]))
            {
         ...
         if(_loc8_)
         {
            ...
            while(_loc7_ < _loc9_)
            {
               ...
               _loc16_ = int(_loc4_._hash[_loc15_ * 73856093 & _loc4_._mask]);
               if(_loc16_ != -1)
               {
      ...
      public function hasFront(param1:Hashable) : Boolean
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc3_:IntIntHashTable = _h;
         var _loc4_:int = int(param1.key);
         var _loc5_:* = _loc4_ * 73856093 & _loc3_._mask;
         var _loc6_:int = int(_loc3_._hash[_loc5_]);
         if(_loc6_ == -1)
         {
            §§push(-2147483648);
         }
      ...
      public function has(param1:Object) : Boolean
      {
         ...
         var _loc5_:int = int(_loc3_._hash[_loc4_ * 73856093 & _loc3_._mask]);
         if(_loc5_ == -1)
         {
            §§push(-2147483648);
         }
      ...
      public function clone(param1:Boolean, param2:Object = undefined) : Collection
      {
         ...
         var _loc3_:* = param2;
         var _loc4_:HashSet = Instance.createEmpty(HashSet);
         _loc4_._isResizable = _isResizable;
      ...
      public function _shrink() : void
      {
         var _loc4_:int = 0;
         var _loc6_:int = 0;
         var _loc9_:* = null as IntIntHashTable;
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         --_sizeLevel;
