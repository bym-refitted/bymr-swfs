package
{
   ...
   public class YARD_PROPS
   {
      public static const _yardProps:Array = [{
         ...
         "quantity":[0,0,30,60,2 * 60,200,220,280,5 * 60,340,400],
         ...
         "hp":[150 * 60,210 * 60,294 * 60,441 * 60,34400,42200,50000,58000],
         "repairTime":[24 * 60,48 * 60,96 * 60,192 * 60,23000,46000,92000,184000]
      },{
         "id":24,
         "group":3,
         "order":6,
         ...
         "quantity":[0,0,0,0,1,2,3,3,3,3,3],
         "hp":[250 * 60,22000,500 * 60,800 * 60,60 * 1000,20 * 60 * 60,82000,25 * 60 * 60],
         "repairTime":[32 * 60,0xf00,128 * 60,9260,200 * 60,5 * 60 * 60,400 * 60,500 * 60]
      },{
         "id":26,
         "group":2,
         "order":5,
         ...
         "hp":[294 * 60,34400,750 * 60,58000,75500,25 * 60 * 60,100000,110000],
         "repairTime":[48 * 60,96 * 60,192 * 60,23000,46000,69000,103500,155250]
      },{
         "id":119,
         "group":3,
         "order":10,
         ...
         "repairTime":[24 * 60,48 * 60,96 * 60,192 * 60,23000,23000,23000,23000]
      },{
         "id":130,
         "group":3,
         "order":2,
