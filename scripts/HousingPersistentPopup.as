package
{
   ...
   public class HousingPersistentPopup extends HousingPersistentPopup_CLIP
   {
      ...
      public function HousingPersistentPopup()
      {
         ...
         {
            _loc10_ = _loc9_[_loc1_].id;
            _loc11_ = new HousingPersistentMonsterBar(_loc10_);
            _loc11_.x = 0;
            _loc3_ = _loc1_;
      ...
      private function healPartialWithGoo(param1:HousingPersistentMonsterBar) : void
      {
         ...
         var _loc6_:Object = GLOBAL.player.getNumToHealByResourceCost(_loc2_,_loc4_);
         if(!_loc6_.num)
         {
            return;
         }
      ...
      private function reorganize() : void
      {
         ...
         _loc5_ = GLOBAL.player.healQueue;
      ...
      public function juiceCheck(param1:MouseEvent = null) : void
      {
         ...
         for(_loc10_ in this._juiceList)
         {
            ...
            _loc3_ += _loc4_;
            _loc9_ = _loc7_.monsterListByID(_loc10_).m_creeps;
         ...
         var _loc12_:MESSAGE = GLOBAL.Message(_loc2_,KEYS.Get("btn_juicemonsters"),this.juice,null);
      ...
      public function getHousableCreatures() : Array
      {
         ...
         var _loc2_:Array = [];
         var _loc3_:Array = [];
         var _loc4_:Vector.<MonsterData> = GLOBAL.player.monsterList;
         var _loc5_:int = int(_loc4_.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc7_ = CREATURELOCKER._creatures[_loc4_[_loc6_].m_creatureID];
            if(!_loc7_.blocked && Boolean(_loc4_[_loc6_].numHousedCreeps))
            {
               ...
               while(_loc8_ < _loc1_)
               {
                  if(_loc4_[_loc6_].m_creeps[_loc8_].ownerID)
                  {
                     if(!this.m_bunkerIDList[_loc4_[_loc6_].m_creeps[_loc8_].ownerID])
                     {
                        ...
                        _loc7_ = new Object();
                        _loc7_.id = "B" + _loc4_[_loc6_].m_creeps[_loc8_].ownerID;
                        _loc7_.index = 5 * 60;
                        _loc2_.push(_loc7_);
                     }
                  }
