package com.monsters.components.abilities
{
   ...
   public class ProximityLootBuff extends Component
   {
      ...
      protected var _championOwner:CHAMPIONMONSTER;
      ...
      override public function register(param1:CreepBase, param2:String = null) : void
      {
         super.register(param1,param2);
         this._championOwner = param1 as CHAMPIONMONSTER;
      ...
      override public function tick(param1:int = 1) : Boolean
      {
         ...
         if(owner._behaviour !== CreepBase.k_sBHVR_ATTACK && owner._behaviour !== CreepBase.k_sBHVR_BOUNCE)
         {
            return false;
         }
