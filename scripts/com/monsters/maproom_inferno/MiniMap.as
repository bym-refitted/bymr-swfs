package com.monsters.maproom_inferno
{
   ...
   public class MiniMap extends MovieClip
   {
      ...
      private static const COLOR1:uint = 0xff00;
      
      private static const COLOR2:uint = 0xffff00;
      
      private static const COLOR3:uint = 0xff9900;
      
      private static const COLOR4:uint = 0xff0000;
      ...
      public function Setup() : void
      {
         ...
         this.selector.graphics.lineStyle(1,0xffffff,1,false);
         this.selector.graphics.beginFill(0xffffff,0.5);
      ...
      public function Update(param1:Array, param2:Array) : void
      {
         ...
         if(MAPROOM_DESCENT.DescentPassed)
         {
            ...
            {
               this.dotAt(_loc5_.x * _loc3_,_loc5_.y * _loc3_,0xff0000,this.ai);
            }
         }
         else
         {
