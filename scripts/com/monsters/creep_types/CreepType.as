package com.monsters.creep_types
{
   ...
   public class CreepType extends ExposedObject
   {
      ...
      private var m_Stream:Vector.<String> = new Vector.<String>();
      
      private var m_BaseProps:CreepProps = new CreepProps();
      
      private var m_Upgrades:Vector.<CreepUpgrade> = new Vector.<CreepUpgrade>();
      
      public var trainingCosts:Array = new Array();
