package com.monsters.maproom3
{
   ...
   public class MapRoom3CellMouseover extends Sprite
   {
      ...
      private static const INFO_TEXT_COLOR_DEFAULT:uint = 0xffffff;
      
      private static const INFO_TEXT_COLOR_BUFF_BLUE:uint = 42495;
      
      private static const INFO_TEXT_COLOR_BUFF_RED:uint = 0xff0000;
      ...
      private function SetInfo(param1:MapRoom3Cell) : void
      {
         ...
         var _loc4_:MapRoom3AllianceData = param1.GetAllianceData();
         if(_loc4_ != null)
         {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.m_ButtonDisplay.getChildAt(_loc8_);
            _loc6_.x = _loc5_;
            _loc5_ += _loc6_.width;
            _loc8_++;
         }
         ...
         var _loc9_:uint = uint(this.m_TextDisplay.numChildren);
         var _loc10_:int = _loc9_ <= 3 ? 6 : 0;
         _loc8_ = 0;
         while(_loc8_ < _loc9_)
         {
            _loc6_ = this.m_TextDisplay.getChildAt(_loc8_);
            _loc6_.y = _loc10_;
            _loc10_ += 12;
            _loc8_++;
         }
