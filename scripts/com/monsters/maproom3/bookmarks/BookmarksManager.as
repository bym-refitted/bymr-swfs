package com.monsters.maproom3.bookmarks
{
   ...
   public class BookmarksManager
   {
      ...
      private var m_CustomBookmarks:Vector.<Bookmark> = new Vector.<Bookmark>();
      
      private var m_EnemyBookmarks:Vector.<Bookmark> = new Vector.<Bookmark>();
      
      private var m_FriendBookmarks:Vector.<Bookmark> = new Vector.<Bookmark>();
      
      private var m_PlayerResourceBookmarks:Vector.<Bookmark> = new Vector.<Bookmark>();
      
      private var m_PlayerStrongholdBookmarks:Vector.<Bookmark> = new Vector.<Bookmark>();
      ...
      private function LoadBookmarksOfType(param1:Array, param2:MapRoom3Data, param3:int) : void
      {
         ...
         var _loc4_:Vector.<Bookmark> = this.GetBookmarksOfType(param3);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         {
            _loc9_ = param1[_loc12_];
            if(_loc9_ != null)
            {
               _loc5_ = int(_loc9_.x);
               _loc6_ = int(_loc9_.y);
               _loc10_ = param2.GetMapRoom3Cell(_loc5_,_loc6_);
               if(_loc10_ != null)
               {
                  _loc7_ = _loc9_.n;
      ...
      {
         var _loc4_:Vector.<Bookmark> = this.GetBookmarksOfType(param2);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function RemoveBookmark(param1:MapRoom3Cell, param2:int = 0, param3:Boolean = true) : void
      {
         ...
         var _loc5_:Bookmark = this.FindBookmark(param1,param2);
         if(_loc5_ == null)
         {
            return;
         }
         var _loc6_:int = int(_loc4_.indexOf(_loc5_));
         if(_loc6_ < 0)
         {
            return;
         }
      ...
      private function FindBookmark(param1:MapRoom3Cell, param2:int = 0) : Bookmark
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ != null && _loc4_.mapCell == param1)
            {
               return _loc4_;
            }
            _loc6_++;
