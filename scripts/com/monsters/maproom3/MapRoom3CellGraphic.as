package com.monsters.maproom3
{
   ...
   public class MapRoom3CellGraphic extends Sprite
   {
      ...
      private static const CONNECTING_LINE_RED:uint = 0xff0000;
      
      private static const CONNECTING_LINE_NEUTRAL:uint = 0xffffff;
      ...
      public function MapRoom3CellGraphic()
      {
         ...
         DrawProceduralHexagon(this.m_Hitbox.graphics,0xff0000,0);
      ...
      private function DrawTiledOvalsRange() : void
      {
         ...
         DrawProceduralEllipse(this.m_RangeLayer.graphics,0xffffff,1,_loc1_);
         DrawProceduralEllipse(this.m_RangeGlowLayer.graphics,0xffffff,1,_loc1_);
      ...
      private function DrawTiledHexagonsRange() : void
      {
         ...
         DrawProceduralHexagon(this.m_RangeLayer.graphics,0xffffff,1);
         DrawProceduralHexagon(this.m_RangeGlowLayer.graphics,0xffffff,1);
         MapRoom3.mapRoom3Window.rangeLayer.addChild(this.m_RangeLayer);
         MapRoom3.mapRoom3Window.rangeGlowLayer.addChild(this.m_RangeGlowLayer);
      }
      ...
      private function DrawCircularRange() : void
      {
         ...
         DrawProceduralEllipse(this.m_RangeLayer.graphics,0xffffff,1,_loc2_);
         DrawProceduralEllipse(this.m_RangeGlowLayer.graphics,0xffffff,1,_loc2_);
      ...
      private function DrawRoundedHexagonalRange() : void
      {
         ...
         DrawProceduralRangeHexagon(this.m_RangeLayer.graphics,0xffffff,1,_loc3_,_loc4_,_loc2_);
         DrawProceduralRangeHexagon(this.m_RangeGlowLayer.graphics,0xffffff,1,_loc3_,_loc4_,_loc2_);
         if(this.m_Cell.hasCellsInAttackRange == true)
         {
            MapRoom3.mapRoom3Window.rangeLayer.addChild(this.m_RangeLayer);
            MapRoom3.mapRoom3Window.rangeGlowLayer.addChild(this.m_RangeGlowLayer);
      ...
      private function DrawIconLayer() : void
      {
         ...
         if(_loc2_)
         {
            _loc4_ = new Bitmap(MapRoom3AssetCache.instance.GetAsset(MapRoom3AssetCache.CELL_ICON_FULLY_FORTIFIED_BACK));
            _loc4_.x = Math.round((HEX_WIDTH - _loc4_.width) * 0.5);
      ...
      private function DrawBuffedEffect() : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc6_ = this.m_Cell.inRangeOfStrongholds[_loc4_];
            if(_loc6_.isOwnedByPlayer)
            {
               _loc2_ = true;
            }
      ...
      private function DrawConnectingLineTo(param1:MapRoom3Cell, param2:uint) : void
      {
         ...
         _loc5_.graphics.lineStyle(CONNECTING_LINE_THICKNESS,param2,CONNECTING_LINE_ALPHA);
         _loc5_.graphics.lineTo(_loc3_ - x,_loc4_ - y);
         var _loc6_:* = _loc5_.x + HEX_WIDTH * 0.5;
         _loc5_.x += HEX_WIDTH * 0.5;
         _loc6_;
         _loc6_ = _loc5_.y + HEX_HEIGHT * 0.5;
         _loc5_.y += HEX_HEIGHT * 0.5;
         _loc6_;
      ...
      private function DrawInfoLayer() : void
      {
         ...
         _loc1_.defaultTextFormat = new TextFormat("Verdana",10,0xffffff,true,null,null,null,null,TextFormatAlign.CENTER);
      ...
      private function DrawHighlightLayer() : void
      {
         ...
         var _loc1_:* = HEX_HEIGHT * 0.5 - HEX_HEIGHT_OVERLAP * 0.5;
         this.m_HighlightLayer.y = HEX_HEIGHT * 0.5 - HEX_HEIGHT_OVERLAP * 0.5;
         _loc1_;
         if(this.m_Selected)
         {
            DrawProceduralEllipse(this.m_HighlightLayer.graphics,0xffffff,0.5);
         }
         else if(this.m_Mousedover)
         {
            DrawProceduralEllipse(this.m_HighlightLayer.graphics,0xffffff,0.3);
         }
      }
