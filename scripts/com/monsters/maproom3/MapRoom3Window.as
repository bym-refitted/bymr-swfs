package com.monsters.maproom3
{
   ...
   public class MapRoom3Window extends Sprite
   {
      ...
      private static const RANGE_GLOW_COLOUR:uint = 0x3399cc;
      
      private static const MOUSEOVER_RANGE_GLOW_COLOUR:uint = 0xff0000;
      ...
      private function DrawRangeAlphaLayer(param1:Sprite) : void
      {
         ...
         param1.graphics.beginFill(0xffffff,RANGE_LAYER_ALPHA);
