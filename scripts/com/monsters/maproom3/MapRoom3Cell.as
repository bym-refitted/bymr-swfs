package com.monsters.maproom3
{
   ...
   {
      private static const ATTACK_COST_MULTIPLIERS_BY_TOWN_HALL_LEVEL:Array = [0,100,200,400,800,1600,0xfa0,10000,25000,75000,225000];
      ...
      public static function GetHexDistanceBetween(param1:IMapRoomCell, param2:IMapRoomCell) : int
      {
         ...
         _loc6_ = param2.cellX - Math.floor(_loc4_ * 0.5);
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            switch(_loc10_.cellType)
            {
               ...
               case EnumYardType.STRONGHOLD:
                  ...
                  _loc12_ = Math.max(0,_loc11_ - _loc10_.attackRange);
                  if(_loc12_ < _loc2_)
                  {
                     _loc2_ = _loc12_;
                     _loc3_ = _loc10_;
