package com.monsters.monsters.components.abilities
{
   ...
   public class ProximityLootBuff extends Component implements ITickable
   {
      ...
      private var m_buddiesInRange:Vector.<MonsterBase> = new Vector.<MonsterBase>();
      ...
      private function removeBuffFromCreepsNoLongerInRange() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            _loc4_ = this.m_buddiesInRange[_loc3_];
            _loc5_ = _loc4_.getComponentByType(LootingMultiplier) as LootingMultiplier;
