package com.monsters.monsters.components
{
   ...
   public class CProperty extends Component
   {
      ...
      protected var _value:Number = this._maximum;
      ...
      public function method_1(param1:Number, param2:* = null) : Number
      {
         this.value = param1;
         return this.value;
      }
      ...
      {
         return this.method_1(this._minimum,param1);
      }
      
      public function maximize(param1:* = null) : Number
      {
         return this.method_1(this._maximum,param1);
      }
