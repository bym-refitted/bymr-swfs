   ...
   public class CREEP_INFERNO extends CreepBase
   {
      ...
      public function ModeDecoy() : void
      {
         ...
         if(Boolean(_loc1_) && _loc1_ is Decoy)
         {
            ...
            if(_movement == "burrow")
            {
               _hasTarget = true;
               _hasPath = true;
               _loc6_ = GRID.FromISO(_loc3_.x,_loc3_.y);
               _loc7_ = int(Math.random() * 4);
               _loc8_ = _loc3_.height;
               _loc9_ = _loc3_.width;
               if(_loc7_ == 0)
               {
                  _loc6_.x += Math.random() * _loc8_;
                  _loc6_.y += _loc9_;
               }
               else if(_loc7_ == 1)
               {
               ...
               {
                  _loc6_.x += _loc8_ - Math.random() * _loc8_ / 2;
                  _loc6_.y -= _loc9_ / 4;
               }
               else if(_loc7_ == 3)
               {
                  _loc6_.x -= _loc8_ / 4;
                  _loc6_.y += _loc9_ - Math.random() * _loc9_ / 2;
               }
               _waypoints = [GRID.ToISO(_loc6_.x,_loc6_.y,0)];
            ...
            else if(_movement == "fly")
            {
               ...
               {
                  _loc4_ = Math.atan2(_tmpPoint.y - _targetCenter.y,_tmpPoint.x - _targetCenter.x) * 57.2957795;
                  _loc4_ = _loc4_ + (Math.random() * 90 - 45);
                  _loc4_ = _loc4_ / (180 / Math.PI);
                  _loc5_ = 30 + Math.random() * 10;
                  _loc10_ = new Point(_targetCenter.x + Math.cos(_loc4_) * _loc5_ * 1.7,_targetCenter.y + Math.sin(_loc4_) * _loc5_);
                  _waypoints = [_loc10_];
                  _targetPosition = _waypoints[0];
               }
            }
            else
            {
               ...
               _loc4_ = _loc4_ / (180 / Math.PI);
               _loc5_ = 30 + Math.random() * 10;
               _loc11_ = new Point(_targetCenter.x + Math.cos(_loc4_) * _loc5_ * 1.7,_targetCenter.y + Math.sin(_loc4_) * _loc5_);
      ...
      public function WormzerBlast() : void
      {
         ...
         if(_behaviour == "attack")
         {
            ...
            {
               if(_loc7_._class != "decoration" && _loc7_._class != "enemy" && _loc7_._class != "trap")
               {
                  _loc4_.x = _loc7_.x;
                  _loc4_.y = _loc7_.y;
                  _loc3_ = PATHING.FromISO(_loc4_);
                  _loc4_.x = _loc7_._middle;
                  _loc4_.y = _loc7_._middle;
                  _loc3_.add(_loc4_);
                  _loc5_ = GLOBAL.QuickDistance(_loc2_,_loc3_);
                  if(_loc5_ < 100)
                  {
                     _loc7_.Damage(int(_damage.Get() * _loc1_ * ((100 - _loc5_) / 100)),_tmpPoint.x,_tmpPoint.y,_targetGroup,false,_secureLootMult);
                     _loc7_.Update(true);
                  }
               }
            }
            ...
            {
               if(GLOBAL.QuickDistance(_tmpPoint,_targetCreep._tmpPoint) < 90)
               {
                  _targetCreep._health.Add(-(_damage.Get() * _loc1_ * _targetCreep._damageMult));
               }
               for each(_loc6_ in CREATURES._creatures)
               {
                  if((_loc6_._behaviour == k_sBHVR_DEFEND || _loc6_._behaviour == k_sBHVR_BUNKER) && _loc6_ != _targetCreep)
                  {
                     _loc5_ = GLOBAL.QuickDistance(_loc6_._tmpPoint,_tmpPoint);
                     if(_loc5_ < 60)
                     {
                        _loc6_._health.Add(-int(_damage.Get() * _loc1_ * _targetCreep._damageMult * ((50 - _loc5_) / 50)));
                     }
                  }
               }
            }
            if(CREATURES._guardian && _targetCreep && CREATURES._guardian._behaviour == k_sBHVR_DEFEND && CREATURES._guardian != _targetCreep && CREATURES._guardian._movement != "fly")
            {
               _loc8_ = GLOBAL.QuickDistance(_targetCreep._tmpPoint,_tmpPoint);
               if(_loc8_ < 60)
               {
                  _targetCreep._health.Add(-int(_damage.Get() * _loc1_ * _targetCreep._damageMult * ((60 - _loc8_) / 60)));
               }
            }
         ...
         else
         {
            ...
            ATTACK.Damage(_tmpPoint.x,_tmpPoint.y - 5,_damage.Get() * _loc9_,_mc.visible);
            _targetCreeps = MAP.CreepCellFind(_tmpPoint,60,-1);
            _loc10_ = 0;
            while(_loc10_ < _targetCreeps.length)
            {
               _loc6_ = _targetCreeps[_loc10_].creep;
               if(_loc10_ == 0)
               {
                  _loc11_ = _loc9_;
               }
               ...
               {
                  _loc11_ = int(_loc9_ * ((60 - _targetCreeps[_loc10_].dist) / 60));
               }
               _loc6_._health.Add(-(_damage.Get() * _loc11_ * _loc6_._damageMult));
               _loc10_++;
            }
         }
      }
