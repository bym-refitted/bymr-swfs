package com.monsters.baseBuffs.buffs
{
   ...
   public class AllianceArmamentBuff extends BaseBuff
   {
      ...
      override public function apply() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            _loc4_ = _loc1_[_loc2_] as BTRAP;
            _loc4_.damageProperty.addModifier(new ArmamentTrapDamageMultiplier());
            _loc2_++;
         }
      }
      ...
      override public function clear() : void
      {
         ...
         {
            _loc4_ = _loc1_[_loc2_] as BTRAP;
            _loc4_.damageProperty.removeModifier(_loc4_.damageProperty.getModifierByType(ArmamentTrapDamageMultiplier));
            _loc2_++;
         }
      }
   }
