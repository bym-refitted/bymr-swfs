package com.monsters.projectiles
{
   ...
   public class ResurrectProjectile extends Projectilev2
   {
      ...
      private function randerElectricityAroundProjectile(param1:Point, param2:BitmapData) : void
      {
         ...
         var _loc4_:ITargetable = Targeting.getClosestEnemy(k_MAX_DISTANCE_TO_LIGHTNING_TARGET,param1,Targeting.k_TARGETS_ALL);
         if(_loc4_)
         {
         ...
         EFFECTS.Lightning(param1.x + Math.random() * param2.width,param1.y + Math.random() * param2.height,_loc3_.x,_loc3_.y,null,0xff00);
      }
