package com.monsters.chat.ui
{
   ...
   public class AbstractChatBox extends MovieClip
   {
      ...
      protected var _inputHeight:int = this._fontSize + 5;
      
      protected var _defaultTxtBG:uint = 14596743;
      
      protected var _highlightTxtBG:uint = 15918030;
      
      protected var fmt:TextFormat = new TextFormat(this._fontName,this._fontSize,this._defaultColor);
      
      protected var fmt_input:TextFormat = new TextFormat(this._fontName,this._fontSize,this._inputColor);
      
      protected var fmt_userIndent:TextFormat = new TextFormat(this._fontName,this._fontSize,this._defaultColor);
