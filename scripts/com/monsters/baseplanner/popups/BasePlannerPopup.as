   ...
   public class BasePlannerPopup extends Sprite
   {
      ...
      public function configPopupTemplate(param1:int = 0, param2:int = 0) : void
      {
         ...
         if(!this.bottomMenu)
         {
            ...
            _loc7_ = Checkbox.Replace(this.bottomMenu.check2);
            _loc7_.addEventListener(Checkbox.CHECK_EVENT,this.onCheckboxClick);
            this.bottomMenu.addChild(_loc7_);
            _loc8_ = Checkbox.Replace(this.bottomMenu.check3);
            _loc8_.addEventListener(Checkbox.CHECK_EVENT,this.onCheckboxClick);
            this.bottomMenu.addChild(_loc8_);
            if(this.bottomMenu.check4)
            {
               _loc9_ = Checkbox.Replace(this.bottomMenu.check4);
               _loc9_.addEventListener(Checkbox.CHECK_EVENT,this.onCheckboxClick);
         ...
         this.bottomMenu.x = param1 - (_layoutSpacing.x + 520) + _loc3_.x;
