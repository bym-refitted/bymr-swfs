package com.monsters.baseplanner
{
   ...
   public class PlannerDesignView extends Sprite
   {
      ...
      private var fontSize:Point = new Point(14,12);
      ...
      public function populateBuildingItems(param1:Vector.<PlannerNode>) : void
      {
         ...
         {
            _loc4_ = new BuildingItem(param1[_loc3_]);
            _loc4_.addEventListener(BUILDING_CLICK,this.onBuildingClick);
      ...
      private function drawYardBounds() : void
      {
         ...
         if(_loc6_)
         {
            ...
            _loc9_ = new DashedLine(this.BOUNDS_LINE_WEIGHT,this.BOUNDS_DASHEDLINE_COLOR,new Array(8,4,2,4));
            _loc9_.moveTo(_loc6_.x,_loc6_.y);
         ...
         _loc7_.graphics.lineStyle(this.BOUNDS_LINE_WEIGHT,this.BOUNDS_LINE_COLOR,1);
         _loc7_.graphics.beginFill(0xffffff,0.25);
      ...
      private function drawRanges() : void
      {
         ...
         while(_loc4_ < this._layerSetBuildings.numChildren)
         {
            ...
            if(_loc3_)
            {
               ...
               _loc1_.graphics.lineStyle(3,0xffffff,0.25);
               _loc1_.graphics.beginFill(0xff0000,0.1);
