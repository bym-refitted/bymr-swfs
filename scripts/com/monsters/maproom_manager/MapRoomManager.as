package com.monsters.maproom_manager
{
   ...
   public class MapRoomManager
   {
      ...
      private var m_AttackCostMultiplier:CModifiableProperty = new CModifiableProperty(Number.MAX_VALUE,Number.MIN_VALUE,1);
      ...
      {
         var _loc4_:MapRoom3 = this.m_CurrentMapRoom as MapRoom3;
         return !!_loc4_ ? _loc4_.GetHexCellsInRange(param1,param2,param3) : new Vector.<MapRoom3Cell>();
      }
      
      public function GetClosestCell(param1:int, param2:int, param3:int) : MapRoom3Cell
      {
         var _loc4_:MapRoom3 = this.m_CurrentMapRoom as MapRoom3;
         return !!_loc4_ ? _loc4_.GetClosestCell(param1,param2,param3) : null;
      }
