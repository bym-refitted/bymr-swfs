package com.monsters.ai
{
   ...
   public class PROCESS4 implements IPROCESS
   {
      ...
      public function ProcessC(param1:Solution) : void
      {
         ...
         var _loc11_:int = int(WMATTACK._fodder.length - 1) * _loc10_;
         var _loc12_:int = _loc11_ == 0 ? _loc11_ : _loc11_ - 1;
         var _loc13_:int = _loc11_ == WMATTACK._fodder.length - 1 ? _loc11_ : _loc11_ + 1;
         var _loc14_:String = WMATTACK._fodder[_loc12_];
         var _loc15_:String = WMATTACK._fodder[_loc11_];
         var _loc16_:String = WMATTACK._fodder[_loc13_];
