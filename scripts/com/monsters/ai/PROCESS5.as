   ...
   public class PROCESS5 implements IPROCESS
   {
      ...
      public function ProcessC(param1:Solution) : void
      {
         ...
         if(param1.damageTaken > 0)
         {
            ...
            _loc12_ = (_loc5_ - _loc11_) / (_loc9_ + 1);
         ...
         var _loc14_:Number = BASE.BaseLevel().level / 40;
         if(_loc14_ < 0)
         {
            _loc14_ = 0;
         }
         ...
         var _loc15_:String = WMATTACK._looters[int((WMATTACK._looters.length - 2) * _loc14_)];
         var _loc16_:String = WMATTACK._tanks[int((WMATTACK._tanks.length - 1) * _loc14_)];
         var _loc17_:String = WMATTACK._kamikaze[int((WMATTACK._kamikaze.length - 1) * _loc14_)];
