   ...
   public class PROCESS5 implements IPROCESS
   {
      ...
      public function ProcessC(param1:Solution) : void
      {
         ...
         for(_loc5_ in BASE._buildingsAll)
         {
            ...
            if(_loc24_._class == "special" || _loc24_._class == "tower" || _loc24_._class == "trap" || _loc24_._class == "wall" || _loc24_._class == "resource")
            {
               if(_loc24_._class != "trap" && _loc24_._class != "wall")
               {
                  _loc4_ += 0.3 * WMATTACK._attackVolumeAmplifier;
               }
               else if(_loc24_._class == "wall")
               {
                  _loc4_ += 0.01 * WMATTACK._attackVolumeAmplifier;
               }
            }
         }
         ...
         if(param1.damageTaken > 0)
         {
            ...
            _loc10_ = (_loc4_ - _loc9_) / (_loc7_ + 1);
         ...
         var _loc12_:Number = BASE.BaseLevel().level / 40;
         if(_loc12_ < 0)
         {
            _loc12_ = 0;
         }
         ...
         if(_loc11_ >= 1)
         {
            ...
            _loc17_[_loc15_] = 40 + _loc16_ * CREATURELOCKER._creatures[_loc15_].props.speed[0];
         }
         if(_loc9_ >= 1)
         {
            if(_loc16_ == 0)
            ...
            _loc17_[_loc13_] = 80 + _loc16_ * CREATURELOCKER._creatures[_loc13_].props.speed[0];
         }
         if(_loc14_ == "C12")
         {
            _loc10_ = Math.ceil(_loc10_ / 2);
         }
         _loc2_[_loc13_] = int(_loc9_);
         _loc2_[_loc14_] = int(_loc10_);
         _loc2_[_loc15_] = int(_loc11_);
         var _loc21_:Object = {};
         _loc21_[_loc14_] = int(_loc10_);
         var _loc22_:Object = {};
         _loc22_[_loc15_] = int(_loc11_);
         var _loc23_:Object = {};
         _loc23_[_loc13_] = int(_loc9_);
