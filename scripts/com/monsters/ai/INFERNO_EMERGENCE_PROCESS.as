package com.monsters.ai
{
   ...
   public class INFERNO_EMERGENCE_PROCESS implements IPROCESS
   {
      ...
      public function ProcessC(param1:Solution) : void
      {
         ...
         _loc10_ = (_loc4_ - _loc9_) / (_loc8_ + 1);
         _loc11_ = _loc10_ / _loc8_;
         _loc13_ = BASE.BaseLevel().level * 0.2 * INFERNO_EMERGENCE_EVENT.Lvl / 40;
         if(_loc13_ < 0)
         {
            _loc13_ = 0;
         }
         ...
         var _loc14_:String = WMATTACK._infernoLooters[int((WMATTACK._infernoLooters.length - 1) * _loc13_)];
         var _loc15_:String = WMATTACK._infernoTanks[int((WMATTACK._infernoTanks.length - 1) * _loc13_)];
         var _loc16_:String = WMATTACK._infernoDps[int((WMATTACK._infernoDps.length - 1) * _loc13_)];
         var _loc17_:Number = 0;
         var _loc18_:Object = {};
         var _loc19_:Number = GLOBAL._mapWidth * 0.25;
         var _loc21_:Number = Point.distance(param1.entryPoint,new Point(param1.targetBuilding.x,param1.targetBuilding.y));
         if(_loc21_ < 100)
         {
            _loc19_ += 100 - _loc21_;
         }
