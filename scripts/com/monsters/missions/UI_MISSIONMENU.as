package com.monsters.missions
{
   ...
   public class UI_MISSIONMENU extends UI_MISSIONMENU_CLIP
   {
      ...
      public function UI_MISSIONMENU()
      {
         ...
         this._PriorityMask.graphics.drawRect(0,0,348,this._numPinnedItems * (32 + this._ItemPaddingY * (this._numPinnedItems - 1)));
      ...
      public function CheckMissionsStatus() : void
      {
         ...
         if(QUESTS._completed)
         {
            ...
            {
               _loc3_ = QUESTS._quests[_loc1_].id;
      ...
      private function RebuildContainer() : void
      {
         ...
         if(QUESTS._completed)
         {
            for(_loc1_ in QUESTS._quests)
            {
               _loc5_ = QUESTS._quests[_loc1_].id;
      ...
      private function toggleHide(param1:MouseEvent = null) : void
      {
         ...
         TweenLite.to(this.frame,0.5,{
            "y":_loc4_.y,
            "onUpdate":this.toggleOnUpdate,
            "onComplete":this.toggleVisibleB
         });
         TweenLite.to(this.frame.mcScreen,0.5,{"height":_loc4_.screenHeight});
         TweenLite.to(this.frame.mcMask,0.5,{"height":_loc4_.maskHeight});
         ...
         if(this._open)
         {
            ...
            TweenLite.to(this._PriorityMask,0.5,{
               "autoAlpha":1,
               "ease":Expo.easeOut
            });
            TweenLite.to(this._PriorityContainer,0.5,{
               "autoAlpha":1,
               "ease":Expo.easeOut
            });
         }
