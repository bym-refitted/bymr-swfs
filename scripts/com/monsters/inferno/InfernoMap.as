package com.monsters.inferno
{
   ...
   public class InfernoMap
   {
      ...
      public static var _popupRelocateMe:InfernoPopupRelocateMe;
      ...
      public function InfernoMap()
      {
         super();
      }
      
      public static function get _homeCellContainer() : Object
      {
         return {
            "cell":InfernoMap._homeCell,
            "range":0
         };
      }
      ...
      public static function Show(param1:MouseEvent = null) : void
      {
         ...
         if(BASE.isInferno())
         {
            ...
            GLOBAL._showMapWaiting = 2;
         }
         if(InfernoMap._contacts.length == 0)
         {
            _contacts = [];
      ...
      public static function PreAcceptInvitation(param1:MovieClip) : void
      {
         ...
         _popupRelocateMe = new InfernoPopupRelocateMe();
      ...
      public static function AcceptInvitation(param1:Boolean = false) : void
      {
         ...
         if(Boolean(_migrateThread) && _inviteBaseID != 0)
         {
            ...
            {
               LOGGER.Log("err","InfernoMap.AcceptInvitation HTTP");
            };
      ...
      public static function RejectInvitation(param1:MouseEvent = null) : void
      {
         ...
         if(Boolean(_migrateThread) && _inviteBaseID != 0)
         {
            handleRejectSuccessful = function(param1:Object):void
            {
               ...
               {
                  LOGGER.Log("err","InfernoMap.RejectInvitation",param1.error);
               }
            };
            handleRejectError = function(param1:IOErrorEvent):void
            {
               LOGGER.Log("err","InfernoMap.RejectInvitation HTTP");
            };
      ...
      public static function BookmarksSave() : void
      {
         ...
         handleBMSaveSuccessful = function(param1:Object):*
         {
            if(param1.error != 0)
            {
               LOGGER.Log("err","InfernoMap.BookmarksSave",param1.error);
            }
         };
         handleBMSaveError = function(param1:IOErrorEvent):*
         {
            LOGGER.Log("err","InfernoMap.BookmarksSave HTTP");
         };
      ...
      {
         InfernoMap._bookmarkData = {};
         InfernoMap._bookmarks = [];
         InfernoMap.BookmarksSave();
      }
         ...
         if(force || GLOBAL.Timestamp() - z.updated > 30)
         {
            handleLoadSuccessful = function(param1:Object):void
            {
               ...
               if(param1 && !param1.error && Boolean(param1.data))
               {
                  ...
                  if(!_zones[_loc2_])
                  {
                     _zones[_loc2_] = new infernoMapZone();
                  }
                  ...
                  else if(BASE._needCurrentCell)
                  {
                     if(_zones && _zones[_loc2_] && Boolean(_zones[_loc2_].data) && Boolean(_zones[_loc2_].data[BASE._currentCellLoc.x]))
                     {
                        ...
                        GLOBAL._currentCell = new InfernoMapCell();
               ...
               {
                  LOGGER.Log("err","InfernoMap.Data NO DATA");
               }
               else
               {
                  LOGGER.Log("err","InfernoMap.Data",param1.error);
               }
            };
            handleLoadError = function(param1:IOErrorEvent):void
            {
               ...
               if(_saveErrors >= 3)
               {
                  LOGGER.Log("err","InfernoMap.RequestData HTTP");
      ...
      public static function TransferMonstersA(param1:InfernoMapCell, param2:Object) : void
      {
      ...
      public static function TransferMonstersB(param1:InfernoMapCell) : void
      {
      ...
      public static function TransferMonstersC(param1:InfernoMapCell) : *
      {
         ...
         var cost:int = 0;
         var targetCell:InfernoMapCell = param1;
         if(_monsterTransferInProgress)
         {
            if(targetCell._mine)
            {
