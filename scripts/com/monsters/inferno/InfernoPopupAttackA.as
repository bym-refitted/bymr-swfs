package com.monsters.inferno
{
   ...
   public class InfernoPopupAttackA extends PopupAttackA_CLIP
   {
      ...
      public function InfernoPopupAttackA()
      {
         super();
      ...
      public function Setup(param1:InfernoMapCell) : *
      {
         ...
         else
         {
            ...
            this.tAttackText.htmlText = "<b>" + KEYS.Get("map_attack_btn") + "</b>";
         }
         this._enabled = false;
         this.bAttack.Enabled = false;
         this.ProfilePic();
      ...
      private function Attack(param1:MouseEvent) : *
      {
         ...
         else if(!InfernoMap._flingerInRange)
         {
            if(!InfernoMap._open)
            {
               POPUPS.Next();
      ...
      public function Update() : *
      {
         ...
         var _loc18_:InfernoMapPopupInfoMonster = null;
         var _loc19_:InfernoMapPopupInfoMonster = null;
         ...
         if(InfernoMap._open)
         {
            this._cellsInRange = [InfernoMap._homeCellContainer];
         ...
         if(!this._enabled)
         {
            ...
            this._protectedInRange = false;
            InfernoMap._flingerInRange = false;
            ...
            if(GLOBAL._playerGuardianData && GLOBAL._playerGuardianData.hp.Get() > 0 && InfernoMap._flingerInRange)
            {
               this._monstersInRange = true;
            }
            if(this._monstersInRange)
            {
               ...
               {
                  _loc18_ = new InfernoMapPopupInfoMonster();
               ...
               for(_loc17_ in this._attackMonsters)
               {
                  if(_loc16_ < 4)
                  {
                     _loc19_ = new InfernoMapPopupInfoMonster();
