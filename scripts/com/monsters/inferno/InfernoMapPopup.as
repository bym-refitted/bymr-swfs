package com.monsters.inferno
{
   ...
   public class InfernoMapPopup extends MapRoomPopup_CLIP
   {
      ...
      private var _popupRelocateMe:InfernoPopupRelocateMe;
      
      public var _popupInfoMine:InfernoPopupInfoMine;
      
      public var _popupInfoEnemy:InfernoPopupInfoEnemy;
      
      public var _popupMonsters:InfernoPopupMonstersA;
      
      public var _popupInfoViewOnly:InfernoPopupInfoViewOnly;
      ...
      public var _popupAttackA:InfernoPopupAttackA;
      
      public var _dragged:Boolean;
      
      public var _popupMonstersB:InfernoPopupMonstersB;
      
      public function InfernoMapPopup()
      {
         var r:Rectangle;
         var i:int;
         var w:* = undefined;
         ...
         this._popupInfoMine = new InfernoPopupInfoMine();
         this._popupInfoEnemy = new InfernoPopupInfoEnemy();
         this._popupMonsters = new InfernoPopupMonstersA();
         this._popupMonstersB = new InfernoPopupMonstersB();
         this._popupAttackA = new InfernoPopupAttackA();
         ...
         this._popupRelocateMe = new InfernoPopupRelocateMe();
         ...
         this._popupInfoViewOnly = new InfernoPopupInfoViewOnly();
         if(!InfernoMap._viewOnly)
         {
            this.bHome.SetupKey("btn_home");
            this.bHome.addEventListener(MouseEvent.CLICK,function(param1:MouseEvent):*
            {
               HideBookmarkMenu();
               InfernoMap.JumpTo(GLOBAL._mapHome);
            });
         ...
         else
         {
            ...
            {
               InfernoMap.JumpTo(InfernoMap._inviteLocation);
            });
            this.bBookmarks.buttonMode = true;
         ...
         this.GenerateCells(InfernoMap._homePoint);
      ...
      public function ShowInfo(param1:InfernoMapCell) : void
      {
         if(!param1._updated)
         {
            return;
         ...
         else
         {
            ...
            if(!param1._damage)
            {
               mcInfo.tStatus.htmlText = KEYS.Get("newmap_inf_fine");
            }
      ...
      public function Setup() : void
      {
         ...
         var _loc1_:int = InfernoMap.BookmarkDataGet("mbms");
         if(_loc1_ > 0)
         {
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = InfernoMap.BookmarkDataGet("mbm" + _loc2_);
               _loc4_ = int(_loc3_ / 10000);
               _loc5_ = _loc3_ - _loc4_ * 10000;
               _loc6_ = InfernoMap.BookmarkDataGetStr("mbmn" + _loc2_);
               InfernoMap._currentPosition = new Point(_loc4_,_loc5_);
               InfernoMap.AddBookmark(_loc6_,false);
               _loc2_++;
            }
         }
         else
         ...
         if(InfernoMap._bookmarks.length > 0 || InfernoMap._viewOnly)
         {
            this.bBookmarks.Enabled = true;
         }
         else
      ...
      {
         var _loc3_:int = 0;
         var _loc5_:InfernoMapCell = null;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
      ...
      {
         var _loc1_:InfernoMapCell = null;
         var _loc2_:InfernoMapCell = null;
         this.UpdateResourceDisplay();
         for each(_loc1_ in this._cells)
         {
            _loc1_.Tick();
         }
         _loc2_ = InfernoMap._homeCell;
         if(_loc2_)
         {
            _loc2_.TickHousing();
         }
      ...
      public function Update(param1:Boolean = false) : *
      {
         ...
         var _loc5_:InfernoMapCell = null;
         var _loc6_:InfernoMapCell = null;
         var _loc7_:Object = null;
         var _loc8_:int = 0;
         var _loc9_:InfernoMapCell = null;
         var _loc2_:int = getTimer();
         if(this._fullScreen && GLOBAL._ROOT.stage.displayState == StageDisplayState.NORMAL)
         {
            InfernoMap.ResizeHandler();
            this._fullScreen = false;
            return;
         }
         this._sortArray = [];
         for each(_loc5_ in this._cells)
         {
            ...
            if(this._cellContainer.y + _loc5_.y > this._cellCountY * this._cellHeight - this._cellHeight * 5)
            {
               ...
               if(_loc5_.Y < 0)
               {
                  _loc5_.Y += InfernoMap._mapHeight;
               }
               _loc3_ = true;
            }
            if(this._cellContainer.x + _loc5_.x < -(this._cellWidth * 0.75 * 5))
            {
               _loc5_.x += this._cellCountX * (this._cellWidth * 0.75);
               _loc5_.X += this._cellCountX;
               if(_loc5_.X > InfernoMap._mapWidth - 1)
               {
                  _loc5_.X -= InfernoMap._mapWidth;
               }
               _loc3_ = true;
            ...
            if(this._cellContainer.y + _loc5_.y < -(this._cellHeight * 5))
            {
               _loc5_.y += this._cellCountY * this._cellHeight;
               _loc5_.Y += this._cellCountY;
               if(_loc5_.Y > InfernoMap._mapHeight - 1)
               {
                  _loc5_.Y -= InfernoMap._mapHeight;
               }
               _loc3_ = true;
            ...
            if(_loc5_.X >= InfernoMap._mapWidth)
            {
               _loc5_.X -= InfernoMap._mapWidth;
               _loc3_ = true;
            }
            if(_loc5_.Y >= InfernoMap._mapHeight)
            {
               _loc5_.Y -= InfernoMap._mapHeight;
               _loc3_ = true;
            }
            ...
            _loc7_ = InfernoMap.GetCell(_loc5_.X,_loc5_.Y);
         ...
         if(!InfernoMap._viewOnly)
         {
            ...
            {
               if(Boolean(_loc9_._mine) && _loc9_._base > 0)
               {
                  this.ShowRange(_loc9_,1);
               }
            }
         }
         if(InfernoMap._bookmarks.length > 0 || InfernoMap._viewOnly)
      ...
      public function ShowBubble(param1:InfernoMapCell) : *
      {
      }
      ...
      public function ShowRange(param1:InfernoMapCell, param2:int) : *
      {
         var _loc3_:Object = null;
         var _loc4_:InfernoMapCell = null;
         if(param1._water == 0)
         {
            if(!param1._over)
            {
      ...
      public function ShowRangeInferno(param1:InfernoMapCell) : void
      {
         var _loc3_:Object = null;
         var _loc5_:InfernoMapCell = null;
         var _loc6_:InfernoMapCell = null;
         var _loc2_:int = 0;
         var _loc4_:Vector.<InfernoMapCell> = new Vector.<InfernoMapCell>();
         _loc4_.push(param1);
         while(_loc2_ < _loc4_.length)
         {
            _loc5_ = _loc4_[_loc2_];
            for each(_loc3_ in this.GetCellsInRange(_loc5_.X,_loc5_.Y,1))
            {
               _loc6_ = _loc3_["cell"];
               if((Boolean(_loc6_)) && !_loc6_._water)
               {
                  if(!_loc6_._over)
                  {
                     if(_loc6_._mine)
                     {
                        _loc6_.mc.mcGlow.alpha = 0.5;
                        _loc6_.mc.mcGlow.gotoAndStop(4);
                     }
                     else
                     {
                        _loc6_.mc.mcGlow.alpha = Math.max(_loc6_.mc.mcGlow.alpha,0.35);
                        _loc6_.mc.mcGlow.gotoAndStop(4);
                     }
                  }
                  _loc6_._inRange = true;
                  if(Boolean(_loc6_._mine) && _loc4_.indexOf(_loc6_) == -1)
                  {
                     _loc4_.push(_loc6_);
                  }
               }
      ...
      public function GetCell(param1:int, param2:int) : InfernoMapCell
      {
         var _loc3_:InfernoMapCell = null;
         if(param1 >= InfernoMap._mapWidth)
         {
            param1 -= InfernoMap._mapWidth;
         }
         else if(param1 < 0)
         {
            param1 = InfernoMap._mapWidth + param1;
         }
         if(param2 >= InfernoMap._mapHeight)
         {
            param2 -= InfernoMap._mapHeight;
         }
         else if(param2 < 0)
         {
            param2 = InfernoMap._mapHeight + param2;
         }
      ...
      public function ShowInfoMine(param1:InfernoMapCell) : *
      {
         this.HideBookmarkMenu();
         if(!this._dragged)
         {
      ...
      public function ShowInfoEnemy(param1:InfernoMapCell, param2:Boolean = false) : *
      {
         this.HideBookmarkMenu();
         if(!this._dragged)
         {
      ...
      public function ShowInfoViewOnly(param1:InfernoMapCell, param2:Boolean = false) : *
      {
         if(!this._dragged)
         {
            SOUNDS.Play("click1");
      ...
      public function ShowInfoDestroyed(param1:InfernoMapCell) : *
      {
         this.HideBookmarkMenu();
         if(!this._dragged)
         {
      ...
      public function ShowMonstersA(param1:InfernoMapCell, param2:Boolean = false) : *
      {
         SOUNDS.Play("click1");
         this.HideBookmarkMenu();
         this.HideInfoMine();
      ...
      public function ShowMonstersB(param1:Object, param2:InfernoMapCell) : *
      {
         SOUNDS.Play("click1");
         this.HideBookmarkMenu();
      ...
      public function ShowAttack(param1:InfernoMapCell) : *
      {
         SOUNDS.Play("click1");
         this.HideBookmarkMenu();
      ...
      public function ShowBookmarkMenu(param1:MouseEvent) : *
      {
         ...
         var e:MouseEvent = param1;
         SOUNDS.Play("click1");
         if(!this._menuShown && InfernoMap._bookmarks.length > 0)
         {
            length = int(InfernoMap._bookmarks.length);
            newY = bBookmarks.y;
            i = 0;
            while(i < length)
            {
               ...
               menuItem.tName.text = InfernoMap._bookmarks[i].name;
      ...
      public function JumpToCoordinate(param1:String, param2:String) : String
      {
         ...
         if(!isNaN(_loc3_) && !isNaN(_loc4_))
         {
            _loc5_ = int(_loc3_);
            _loc6_ = int(_loc4_);
            if(_loc5_ >= 0 && _loc5_ < InfernoMap._mapWidth && _loc6_ >= 0 && _loc6_ <= InfernoMap._mapHeight)
            {
               InfernoMap._homePoint = new Point(_loc5_,_loc6_);
               InfernoMap.JumpTo(InfernoMap._homePoint);
               return "";
            }
      ...
      {
         this.HideBookmarkMenu();
         if(InfernoMap._bookmarks.length > param1)
         {
            InfernoMap.JumpTo(InfernoMap._bookmarks[param1].location);
         }
      }
      ...
      public function BookmarkRemove(param1:int) : *
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         InfernoMap._bookmarks.splice(param1,1);
         ...
         if(InfernoMap._bookmarks.length > 0)
         {
            _loc2_ = int(InfernoMap._bookmarks.length);
            _loc3_ = param1;
            while(_loc3_ < _loc2_)
            {
               --this._popupBookmarkMenu[_loc3_].mcBG.index;
               this._popupBookmarkMenu[_loc3_].y -= this._popupBookmarkMenu[_loc3_].height;
               InfernoMap.BookmarkDataSet("mbm" + _loc3_,InfernoMap._bookmarks[_loc3_].location.x * 10000 + InfernoMap._bookmarks[_loc3_].location.y,false);
               InfernoMap.BookmarkDataSetStr("mbmn" + _loc3_,InfernoMap._bookmarks[_loc3_].name,false);
               _loc3_++;
            }
            InfernoMap.BookmarkDataSet("mbms",_loc2_);
         }
         else
         {
            InfernoMap.BookmarksClear();
      ...
      public function ShowBookmarkAddPopup(param1:InfernoMapCell) : *
      {
         SOUNDS.Play("click1");
         InfernoMap._currentPosition = new Point(param1.X,param1.Y);
         this._popupBookmarkAdd.tName.text = KEYS.Get("map_yardowner",{"v1":param1._name});
      ...
      public function ShowRelocateMePopup(param1:InfernoMapCell) : *
      {
         SOUNDS.Play("click1");
      ...
      {
         GLOBAL.BlockerRemove();
         var _loc2_:Object = InfernoMap.AddBookmark(this._popupBookmarkAdd.tName.text);
      ...
      {
         GLOBAL.BlockerAdd(this);
         this.addChild(new InfernoMapGuide());
      }
   }
}
