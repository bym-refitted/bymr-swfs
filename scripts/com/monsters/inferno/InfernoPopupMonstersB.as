package com.monsters.inferno
{
   ...
   public class InfernoPopupMonstersB extends PopupMonstersB_CLIP
   {
      public var _cell:InfernoMapCell;
      
      public var _transfer:Object;
      
      public var _mcMonsters:MovieClip;
      
      public function InfernoPopupMonstersB()
      {
         super();
         x = 455;
         y = 250;
         ...
         {
            InfernoMap.TransferMonstersC(_cell);
         });
         this.bCancel.SetupKey("btn_cancel");
         this.bCancel.addEventListener(MouseEvent.CLICK,this.Hide);
      }
      
      public function Setup(param1:Object, param2:InfernoMapCell) : *
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:String = null;
         var _loc6_:InfernoMapPopupInfoMonster = null;
         ...
         if(this._transfer)
         {
            ...
            for(_loc5_ in this._transfer)
            {
               ...
               {
                  _loc6_ = new InfernoMapPopupInfoMonster();
