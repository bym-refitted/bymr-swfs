package com.monsters.inferno
{
   ...
   public class InfernoPopupInfoViewOnly extends PopupInfoViewOnly_CLIP
   {
      ...
      public function InfernoPopupInfoViewOnly()
      {
         super();
         x = 455;
         y = 260;
      ...
      public function Hide(param1:MouseEvent = null) : *
      {
         ...
         InfernoMap._mc.HideInfoViewOnly();
      }
      ...
      public function Setup(param1:InfernoMapCell, param2:Boolean = false) : *
      {
         ...
         {
            if(this._cell._baseID == InfernoMap._inviteBaseID)
            {
