package com.monsters.mailbox
{
   ...
   public class Inbox extends Inbox_CLIP
   {
      ...
      public function Inbox()
      {
         ...
         title_txt.text = KEYS.Get("mail_title");
      ...
      private function handleLoadSuccessful(param1:Object) : void
      {
         ...
         for(_loc3_ in param1.threads)
         {
            ...
            while(_loc5_ < all.length)
            {
               ...
               {
                  _loc4_ = true;
                  _loc6_ = all[_loc5_].data;
                  _loc7_ = _loc6_.sendtime;
            ...
            if(!_loc4_)
            {
               _loc8_ = new ThreadData(param1.threads[_loc3_]);
               _loc8_.addEventListener(Event.CHANGE,this.listenForFlagging);
