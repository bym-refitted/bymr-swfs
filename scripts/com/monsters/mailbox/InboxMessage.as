package com.monsters.mailbox
{
   ...
   public class InboxMessage extends InboxMessage_CLIP
   {
      ...
      public function getTimeDistanceString(param1:Number) : String
      {
         ...
         {
            _loc4_ = _loc3_;
            _loc5_ = _loc4_ == 1 ? "mail_time_second" : "mail_time_seconds";
         }
         else if(_loc3_ < 3600)
         {
            _loc4_ = int(_loc3_ / 60);
            _loc5_ = _loc4_ == 1 ? "mail_time_minute" : "mail_time_minutes";
         }
         else if(_loc3_ < 86400)
         {
            _loc4_ = int(_loc3_ / 60 / 60);
            _loc5_ = _loc4_ == 1 ? "mail_time_hour" : "mail_time_hours";
         }
         else if(_loc3_ < 604800)
         {
            _loc4_ = int(_loc3_ / 60 / 60 / 24);
            _loc5_ = _loc4_ == 1 ? "mail_time_day" : "mail_time_days";
         }
         else if(_loc3_ < 18748800)
         {
            _loc4_ = int(_loc3_ / 60 / 60 / 24 / 7);
            _loc5_ = _loc4_ == 1 ? "mail_time_week" : "mail_time_weeks";
         }
         else
         {
            _loc4_ = int(_loc3_ / 60 / 60 / 24 / 7 / 31);
            _loc5_ = _loc4_ == 1 ? "mail_time_month" : "mail_time_months";
         }
