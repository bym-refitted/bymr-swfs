   ...
   public class PlayerHandler extends Sprite
   {
      ...
      public function configure(param1:*) : Object
      {
         ...
         if(this.data.wm.Get() == 0)
         {
            ...
            {
               _loc7_ = MapRoom.BRIDGE.KEYS.Get("map_status_friends");
               _loc8_ = "#0000FF";
            }
            if(this.data.attacksfrom.Get() > 1)
            {
               _loc7_ = MapRoom.BRIDGE.KEYS.Get("map_status_hostile");
               _loc8_ = "#990000";
            }
            if(Boolean(this.data.trucestate) && this.data.trucestate != "")
            {
               ...
               {
                  _loc2_ = false;
                  _loc7_ = MapRoom.BRIDGE.KEYS.Get("map_status_tactive");
                  _loc8_ = "#00FF00";
               }
               else if(this.data.trucestate == "requested")
               {
                  _loc7_ = MapRoom.BRIDGE.KEYS.Get("map_status_trequested");
                  _loc8_ = "#0000FF";
               }
               else if(this.data.trucestate == "rejected")
               {
                  _loc7_ = MapRoom.BRIDGE.KEYS.Get("map_status_trejected");
                  _loc8_ = "#CC0000";
               }
               switch(this.data.attackpermitted.Get())
               {
                  case 5:
                     _loc2_ = false;
                     _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_dp");
                     break;
                  case 6:
                     _loc2_ = false;
                     _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_sp");
                     break;
                  case 7:
                     _loc2_ = false;
                     _loc3_ = false;
                     _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_underattack");
                     _loc6_ = "#FF0000";
               }
            }
            else
            {
               ...
               switch(this.data.attackpermitted.Get())
               {
                  case 3:
                     _loc2_ = false;
                     _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_level");
                     break;
                  case 4:
                     _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_vengeance",{"v1":this.data.retaliatecount});
                     _loc6_ = "#FF0000";
                     break;
                  case 5:
                     _loc2_ = false;
            ...
            {
               _loc5_ = MapRoom.BRIDGE.KEYS.Get("map_status_timeremain",{"v1":MapRoom.BRIDGE.GLOBAL.ToTime(this.data.truceexpire,true,false)});
               _loc6_ = "#000000";
            }
      ...
      private function onAttack(param1:MouseEvent) : void
      {
         ...
         var _loc4_:String = "";
         var _loc5_:String = MapRoom.BRIDGE.KEYS.Get("map_attack_btn2");
         ...
         if(MapRoom.BRIDGE.GLOBAL._bFlinger != null && MapRoom.BRIDGE.GLOBAL._bFlinger._canFunction && MapRoom.BRIDGE.GLOBAL._bFlinger._countdownUpgrade.Get() == 0)
         {
            if(_loc2_.wm.Get() == 0)
            {
               ...
               {
                  _loc3_ = false;
                  _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_ownerinyard",{"v1":_loc2_.ownerName});
               }
               else if(MapRoom.BRIDGE.GLOBAL._flags.attacking == 0)
               {
                  _loc3_ = false;
                  _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_attackingdisabled");
               }
               else
               {
                  switch(_loc2_.attackpermitted.Get())
                  {
                     case 1:
                        ...
                        if(_loc2_.friend.Get())
                        {
                           _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_attackfriend",{"v1":_loc2_.ownerName});
                           break;
                        }
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_attackconfirm",{"v1":_loc2_.ownerName});
                        break;
                     case 2:
                        _loc3_ = true;
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_higherlevelconfirm",{"v1":_loc2_.ownerName});
                        break;
                     case 3:
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_leveltoolow");
                        break;
                     case 4:
                        _loc3_ = true;
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_vengeance");
                        break;
                     case 5:
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_dp",{"v1":_loc2_.ownerName});
                        break;
                     case 6:
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_sp",{"v1":_loc2_.ownerName});
                        break;
                     case 7:
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_inprogress",{
                           "v1":_loc2_.ownerName,
                           "v2":_loc2_.attacker
                        });
                        break;
                     case 9:
                        _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_truceactive",{"v1":_loc2_.ownerName});
                  }
               }
            }
            else
            {
               ...
               if(_loc2_.wm.Get() == 0)
               {
                  _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_atatckconfirm",{"v1":_loc2_.ownerName});
         ...
         else
         {
            ...
            {
               _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_needflinger");
            }
            else if(MapRoom.BRIDGE.GLOBAL._bFlinger._countdownUpgrade.Get() > 0)
            {
               _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_flingerupgrading");
            }
            else
            {
               _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_flingerdamaged");
            }
         }
         if(_loc3_)
         {
            ...
            {
               _loc4_ = MapRoom.BRIDGE.KEYS.Get("map_msg_nomonsters");
