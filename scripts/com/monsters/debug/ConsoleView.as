package com.monsters.debug
{
   ...
   public class ConsoleView extends Sprite
   {
      ...
      protected var _outputBitmap:Bitmap = new Bitmap(new BitmapData(640,8 * 60,false,0));
...
class GlyphCache
{
   protected const _textFormat:TextFormat = new TextFormat("Verdana",12,0xdddddd,true);
   ...
   public function drawLineToBitmap(param1:String, param2:int, param3:int, param4:uint, param5:BitmapData) : int
   {
      ...
      {
         _loc11_ = int(param1.charCodeAt(_loc10_));
         if(_loc11_ == 10)
         {
            _loc7_.x = param2;
            _loc7_.y += 16;
