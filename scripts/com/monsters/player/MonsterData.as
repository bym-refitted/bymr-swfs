package com.monsters.player
{
   ...
   public final class MonsterData
   {
      ...
      public function getNumCreepsCanHealWithSpecificResourceAmount(param1:Number, param2:int = 0) : Object
      {
         ...
         while(_loc9_ < _loc8_)
         {
            _loc6_ = (1 - this.m_creeps[_loc9_].health / this.m_maxHealth) * _loc4_;
            if(!(_loc6_ <= param1 && this.m_creeps[_loc9_].ownerID == param2))
            {
               break;
            }
            param1 -= _loc6_;
      ...
      public function getHighestTimeWithHousingSplit(param1:int = 0) : int
      {
         ...
         while(_loc8_ < _loc4_)
         {
            _loc6_ = this.m_creeps[_loc8_];
            if(_loc6_.health < this.m_maxHealth && _loc6_.ownerID == param1 && Boolean(_loc6_.queued))
            {
      ...
      public function heal(param1:int = 0) : Boolean
      {
         ...
         while(_loc11_ < _loc9_)
         {
            ...
            {
               _loc6_ = this.m_creeps[_loc13_];
               if(_loc6_.ownerID == param1 && Boolean(_loc6_.queued))
               {
