package com.monsters.player
{
   ...
   public class Player
   {
      ...
      private var _handlers:Vector.<IHandler> = Vector.<IHandler>([RewardHandler.instance,KOTHHandler.instance,SubscriptionHandler.instance,BaseBuffHandler.instance]);
      ...
      public function addMonster(param1:String, param2:MonsterBase = null) : void
      {
         ...
         var _loc4_:MonsterData = this.monsterListByID(param1);
         if(_loc4_)
         {
            _loc4_.add(1,param2);
         }
         ...
         {
            _loc4_ = new MonsterData();
            _loc4_.m_creatureID = param1;
            _loc4_.add(1,param2);
      ...
      public function getSecsTillDoneByID(param1:String, param2:Boolean = false) : int
      {
         ...
         else
         {
            ...
            _loc7_ = GLOBAL.player.monsterListByID(param1).numCreepsByHouse(0,!param2);
            _loc4_ = (_loc7_ * _loc5_ - GLOBAL.player.monsterListByID(param1).curHealth(0,!param2)) / (_loc5_ / _loc4_);
         }
         return _loc4_;
      }
      ...
      public function importPlayerSpecificHandlers(param1:Object) : void
      {
         ...
         {
            _loc4_ = this.handlers[_loc3_];
            if(_loc4_ is IPlayerHandler)
            {
