package com.monsters.effects.fire
{
   ...
   public class Flame extends Sprite
   {
      ...
      public function Flame(param1:DisplayObject, param2:int, param3:int)
      {
         ...
         this.cooling = 0.1;
         this._coolingBmd1.perlinNoise(this._width * 0.1,this._height * 1,2,Math.random() * 1000,true,false,0,true);
         this._coolingBmd2.perlinNoise(this._width * 2,this._height * 1,2,Math.random() * 1000,true,false,0,true);
      ...
      public function Tick() : void
      {
         ...
         while(_loc4_ = _loc4_.next, _loc4_);
