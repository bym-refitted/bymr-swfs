package com.monsters.effects.particles
{
   ...
   public class ParticleDamageItem extends ParticleDamageItem_CLIP
   {
      ...
      public function Init(param1:Point, param2:int) : *
      {
         var _loc3_:* = "<b>" + param2 + "</b>";
         if(param2 < 0)
         {
            _loc3_ = "<b>" + param2 * -1 + "</b>";
         }
         ...
         if(param2 < 0)
         {
            this._mc.tLootA.htmlText = "<font color=\"#00ff00\">" + _loc3_ + "</font>";
         }
         else
         {
            this._mc.tLootA.htmlText = _loc3_;
         }
