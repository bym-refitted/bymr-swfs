   ...
   public class Smoke
   {
      ...
      public static function Setup() : void
      {
         ...
         try
         {
            ...
            if(!setupCompleted)
            {
               _rect = new Rectangle(0,0,25 * 60,800);
               _frameNumber = 0;
               _sourceID = 0;
               ...
               while(i < 100)
               {
                  tmpW = 5 + 0.25 * i;
                  tmpO = (30 - tmpW) * 0.5;
                  tmpSprite = new BitmapData(tmpW,tmpW,true,0xffffff);
      ...
      private static function Add(param1:Point, param2:int, param3:int, param4:int, param5:Number) : void
      {
         ...
         var _loc6_:SmokeSystem = new SmokeSystem();
         _loc6_.id = _sourceID = _sourceID + 1;
      ...
      public static function Tick() : void
      {
         ...
         if(_frameNumber % 2 == 0)
         {
            if(_loc9_ < 700 && GLOBAL._fps > 20)
            {
               ...
               {
                  _loc5_ = _sources[_loc1_];
                  _loc11_ = _loc5_.basesize * 0.5;
                  --_loc5_.life;
                  ...
                  else
                  {
                     ...
                     {
                        _loc6_ = new SmokeParticle();
                        _loc6_.position = new Point(_loc5_.position.x - _loc11_ + Math.random() * _loc5_.basesize,_loc5_.position.y - _loc11_ + Math.random() * _loc5_.basesize);
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc1_ < _loc9_)
               {
                  ...
                  _loc7_ = int(100 - 33.333333333333336 * _loc6_.speed);
               ...
               while(_loc4_ < GLOBAL._loops)
               {
                  ...
                  {
                     _loc6_ = _particles[_loc1_];
                     _loc6_.position.x = _loc6_.position.x + _loc6_.wind * 0.25;
