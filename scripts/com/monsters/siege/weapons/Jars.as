package com.monsters.siege.weapons
{
   ...
   public class Jars extends SiegeWeapon implements IDurable
   {
      ...
      public function Jars()
      {
         ...
         super();
         addProperty(RANGE,new SiegeWeaponProperty([200,210,235,335,6 * 60,370,380,390,400,410],1));
         addProperty(DURABILITY,new SiegeWeaponProperty([2000,50 * 60,75 * 60,7000,11000,225 * 60,275 * 60,20500,425 * 60,525 * 60],2));
