package com.monsters.siege.weapons
{
   ...
   public class Decoy extends SiegeWeapon
   {
      ...
      public static const EXPLOSION_SOUND:String = "decoyExplosionSound";
      
      public static const LOOPING_SOUND:String = "decoyLoopingSound";
      ...
      public static const LAND_SOUND:String = "decoyLandSound";
      ...
      public function Decoy()
      {
         ...
         super();
         addProperty(DAMAGE,new SiegeWeaponProperty([1000,25 * 60,2500,3500,75 * 60,6500,150 * 60,12500,17000,23500],1));
         addProperty(RANGE,new SiegeWeaponProperty([250,270,290,310,320,350,380,410,440,8 * 60],2));
