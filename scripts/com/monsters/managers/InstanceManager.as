   ...
   public class InstanceManager
   {
      ...
      public static function getInstance(param1:Class) : Object
      {
         ...
         while(_loc3_ != null && _loc3_ != Object)
         {
            ...
            {
               _loc5_ = getQualifiedSuperclassName(_loc3_);
               _loc3_ = !!_loc5_ ? getDefinitionByName(_loc5_) as Class : null;
      ...
      public static function clearInstance(param1:Object) : void
      {
         ...
         if(Boolean(param1.hasOwnProperty(k_ClassDisposalMethod)) && param1[k_ClassDisposalMethod] is Function)
         {
      ...
      public static function clearAll() : void
      {
         ...
         for(_loc4_ in k_Instances)
         {
            ...
            while(_loc5_ >= 0)
            {
               ...
               if(_loc4_ == _loc2_ && Boolean(_loc3_.hasOwnProperty(k_ClassDisposalMethod)) && _loc3_[k_ClassDisposalMethod] is Function)
               {
      ...
      public static function addInstance(param1:Object) : void
      {
         ...
         while(_loc2_ != null && _loc2_ != Object)
         {
            ...
            {
               _loc4_ = getQualifiedSuperclassName(_loc2_);
               _loc2_ = !!_loc4_ ? getDefinitionByName(_loc4_) as Class : null;
