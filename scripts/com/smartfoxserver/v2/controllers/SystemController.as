package com.smartfoxserver.v2.controllers
{
   ...
   public class SystemController extends BaseController
   {
      ...
      override public function handleMessage(param1:IMessage) : void
      {
         ...
         var _loc2_:String = this.requestHandlers[param1.id];
         if(_loc2_ != null)
         {
            this[_loc2_](param1);
         }
      ...
      {
         var _loc2_:String = this.requestHandlers[param1];
      ...
      private function fnCreateRoom(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc5_ = SFSRoom.fromSFSArray(_loc2_.getSFSArray(CreateRoomRequest.KEY_ROOM));
            _loc5_.roomManager = this.sfs.roomManager;
      ...
      private function fnJoinRoom(param1:IMessage) : void
      {
         ...
         if(_loc3_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc7_ = SFSRoom.fromSFSArray(_loc5_);
            _loc7_.roomManager = this.sfs.roomManager;
            ...
            while(_loc8_ < _loc6_.size())
            {
               ...
               _loc10_ = this.getOrCreateUser(_loc9_,true,_loc7_);
               _loc10_.setPlayerId(_loc9_.getShort(3),_loc7_);
      ...
      private function fnUserEnterRoom(param1:IMessage) : void
      {
         ...
         var _loc2_:ISFSObject = param1.content;
         var _loc4_:Room = this.sfs.roomManager.getRoomById(_loc2_.getInt("r"));
         if(_loc4_ != null)
         {
      ...
      private function fnChangeRoomName(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc5_ = this.sfs.roomManager.getRoomById(_loc4_);
            if(_loc5_ != null)
            {
      ...
      private function fnSpectatorToPlayer(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc8_ = this.sfs.roomManager.getRoomById(_loc4_);
            if(_loc8_ != null)
            {
               if(_loc7_ != null)
               {
      ...
      private function fnPlayerToSpectator(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc7_ = this.sfs.roomManager.getRoomById(_loc4_);
            if(_loc7_ != null)
            {
               if(_loc6_ != null)
               {
      ...
      private function fnRemoveBuddy(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc5_ = this.sfs.buddyManager.removeBuddyByName(_loc4_);
            if(_loc5_ != null)
            {
               _loc3_.buddy = _loc5_;
      ...
      private function fnGoOnline(param1:IMessage) : void
      {
         ...
         if(_loc2_.isNull(BaseRequest.KEY_ERROR_CODE))
         {
            ...
            _loc7_ = _loc2_.getByte(GoOnlineRequest.KEY_ONLINE);
            _loc8_ = _loc7_ == BuddyOnlineState.ONLINE;
            _loc9_ = true;
            if(_loc6_)
            {
      ...
      private function fnFindUsers(param1:IMessage) : void
      {
         ...
         while(_loc7_ < _loc4_.size())
         {
            _loc8_ = SFSUser.fromSFSArray(_loc4_.getSFSArray(_loc7_));
      ...
      private function getOrCreateUser(param1:ISFSArray, param2:Boolean = false, param3:Room = null) : User
      {
         ...
         var _loc5_:User = this.sfs.userManager.getUserById(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = SFSUser.fromSFSArray(param1,param3);
            _loc5_.userManager = this.sfs.userManager;
         }
         else if(param3 != null)
         {
