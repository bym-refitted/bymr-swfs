package com.adobe.images
{
   ...
   public class JPGEncoder
   {
      ...
      private var std_ac_luminance_values:Array = [1,2,3,0,4,17,5,18,33,49,65,6,19,81,97,7,34,113,20,50,129,145,161,8,35,66,177,193,21,82,209,4 * 60,36,51,98,114,130,9,10,22,23,24,25,26,37,38,39,40,41,42,52,53,54,55,56,57,58,67,68,69,70,71,72,73,74,83,84,85,86,87,88,89,90,99,100,101,102,103,104,105,106,115,116,117,118,119,2 * 60,121,122,131,132,133,134,135,136,137,138,146,147,148,149,150,151,152,153,154,162,163,164,165,166,167,168,169,170,178,179,3 * 60,181,182,183,184,185,186,194,195,196,197,198,199,200,201,202,210,211,212,213,214,215,216,217,218,225,226,227,228,229,230,231,232,233,234,241,242,243,244,245,246,247,248,249,250];
      ...
      private var std_ac_chrominance_values:Array = [0,1,2,3,17,4,5,33,49,6,18,65,81,7,97,113,19,34,50,129,8,20,66,145,161,177,193,9,35,51,82,4 * 60,21,98,114,209,10,22,36,52,225,37,241,23,24,25,26,38,39,40,41,42,53,54,55,56,57,58,67,68,69,70,71,72,73,74,83,84,85,86,87,88,89,90,99,100,101,102,103,104,105,106,115,116,117,118,119,2 * 60,121,122,130,131,132,133,134,135,136,137,138,146,147,148,149,150,151,152,153,154,162,163,164,165,166,167,168,169,170,178,179,3 * 60,181,182,183,184,185,186,194,195,196,197,198,199,200,201,202,210,211,212,213,214,215,216,217,218,226,227,228,229,230,231,232,233,234,242,243,244,245,246,247,248,249,250];
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc4_:Array = [16,11,10,16,24,40,51,61,12,12,14,19,26,58,60,55,14,13,16,24,40,57,69,56,14,17,22,29,51,87,80,62,18,22,37,56,68,109,103,77,24,35,55,64,81,104,113,92,49,64,78,87,103,121,2 * 60,101,72,92,95,98,112,100,103,99];
         _loc2_ = 0;
         while(_loc2_ < 64)
         {
      ...
      private function initCategoryNumber() : void
      {
         ...
         while(_loc4_ <= 15)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               this.category[0x7fff + _loc3_] = _loc4_;
               this.bitcode[0x7fff + _loc3_] = new BitString();
               this.bitcode[0x7fff + _loc3_].len = _loc4_;
               this.bitcode[0x7fff + _loc3_].val = _loc3_;
               _loc3_++;
            }
            _loc3_ = -(_loc2_ - 1);
            while(_loc3_ <= -_loc1_)
            {
               ...
               this.bitcode[0x7fff + _loc3_] = new BitString();
               this.bitcode[0x7fff + _loc3_].len = _loc4_;
               this.bitcode[0x7fff + _loc3_].val = _loc2_ - 1 + _loc3_;
               _loc3_++;
            }
            _loc1_ <<= 1;
            _loc2_ <<= 1;
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc7_:BitString = param5[4 * 60];
         ...
         {
            this.writeBits(param4[this.category[0x7fff + _loc10_]]);
            this.writeBits(this.bitcode[0x7fff + _loc10_]);
         }
         var _loc11_:int = 63;
         ...
         while(_loc8_ <= _loc11_)
         {
            ...
            this.writeBits(param5[_loc13_ * 16 + this.category[0x7fff + this.DU[_loc8_]]]);
            this.writeBits(this.bitcode[0x7fff + this.DU[_loc8_]]);
            _loc8_++;
         }
         if(_loc11_ != 63)
         {
