package com.cc.screenshot
{
   ...
   public class screenshot_ui extends screenshot_ui_CLIP
   {
      ...
      private var offsetPoint:Point = new Point(-20,-20);
      
      private var presets:Array = [["Normal",0,0,0,0,0,0],["B&W",10,10,-100,0,0,1],["B&W 2",0,40,-100,0,0,1],["Toy",0,0,10,60,0,2],["Toy 2",10,30,20,60,0,2],["Old",10,40,-30,10,1,3]];
