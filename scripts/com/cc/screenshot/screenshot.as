   ...
   public class screenshot
   {
      ...
      public static function Process(param1:int = 0, param2:int = 0, param3:int = 0, param4:int = 0, param5:int = 0, param6:int = 0) : *
      {
         ...
         if(param1 != 0)
         {
            ...
            _loc7_.adjustBrightness(param1);
         ...
         {
            _loc7_ = new ColorMatrix();
            _loc7_.adjustContrast(param2);
            _processedImage.applyFilter(_processedImage,_processedImage.rect,_processedImage.rect.topLeft,new ColorMatrixFilter(_loc7_));
         }
         if(param3 != 0)
         {
            _loc7_ = new ColorMatrix();
            _loc7_.adjustSaturation(param3);
            _processedImage.applyFilter(_processedImage,_processedImage.rect,_processedImage.rect.topLeft,new ColorMatrixFilter(_loc7_));
         }
         if(param4)
         {
            ...
            _loc11_ = new Matrix();
            _loc11_.createGradientBox(_loc10_.width,_loc10_.height * (_loc8_ / 100),90 / (180 / Math.PI),0,_loc10_.height * ((_loc9_ - _loc8_) / 100));
            _loc12_ = new Sprite();
            _loc12_.graphics.beginGradientFill("linear",new Array(0xffffff,0xffffff,0xffffff,0xffffff),new Array(0,1,1,0),new Array(0,85,170,255),_loc11_);
            _loc12_.graphics.drawRect(0,0,_loc10_.width,_loc10_.height);
            _loc13_ = new BitmapData(_loc10_.width,_loc10_.height,true,0xffffff);
         ...
         if(param5 > 0)
         {
            _loc14_ = _rawImage.clone();
            _loc14_.noise(1,0,255,7,true);
