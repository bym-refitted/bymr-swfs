package
{
   ...
   public class PersistentMonsterBunker extends MonsterBunkerPopup_Persistent_CLIP
   {
      ...
      public function PersistentMonsterBunker()
      {
         ...
         this._scrollerA.Init(transferCanvasA,transferCanvasAmask,0,this._scrollerA.y,267);
         this._scrollerB = new ScrollSet();
         this._scrollerB.AutoHideEnabled = false;
         this._scrollerB.width = 16;
         this._scrollerB.x = 5 * 60;
         this._scrollerB.y = -102;
         addChild(this._scrollerB);
         this._scrollerB.Init(transferCanvasB,transferCanvasBmask,0,this._scrollerB.y,267);
      ...
      public function Update() : void
      {
         ...
         while(_loc8_ < _loc18_.length)
         {
            ...
            if(this.CanBunkerFromHousing(_loc1_))
            {
               ...
               _loc21_ = CREATURELOCKER._creatures[_loc1_].name;
               if(_loc1_ == "IC8")
               {
                  _loc21_ = "#m_k_wormzer#";
               }
         ...
         for(_loc2_ in this.m_bunker._monsters)
         {
            _loc22_ = int(this.m_bunker._monsters[_loc2_].length);
            if(_loc22_ > 0)
            {
               _loc7_ = CREATURELOCKER._creatures[_loc2_];
               _loc23_ = new MonsterBunkerPopup_TransferBtnB_CLIP_Persistant();
               _loc23_.id = _loc2_;
