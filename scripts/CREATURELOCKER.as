      ...
      public static function Setup() : *
      {
         ...
         _creatures = {
            "C1":{
               ...
               "unlock":[""],
               "trainingCosts":[[0xfa0,7200],[0x1f40,10800],[200 * 60,18000],[16000,28800]],
               "props":{
                  "speed":[1.2],
                  "health":[200,220,4 * 60,260,280],
                  "damage":[60,65,70,75,80],
                  "cTime":[15,10,8,7,6],
                  "cResource":[250,450,675,800,1000],
                  "cStorage":[10,10,10,9,8],
                  "bucket":[20],
                  "targetGroup":[1]
               }
            },
            "C2":{
               ...
               "trainingCosts":[[0x1f40,14400],[16000,21600],[400 * 60,36000],[800 * 60,57600]],
               "props":{
                  "speed":[1.4],
                  "health":[1000,1100,1300,1450,1600],
                  "damage":[15,15,20,25,30],
                  "cTime":[15,16],
                  "cResource":[500,15 * 60,1350,30 * 60,35 * 60],
                  "cStorage":[10],
                  "bucket":[20],
                  "targetGroup":[4]
               }
            ...
            "C3":{
               ...
               "trainingCosts":[[16000,14400],[32000,21600],[800 * 60,28800],[96000,43200]],
               "props":{
                  "speed":[2.5,2.55,2.6,2.8,3],
                  "health":[150],
                  "damage":[15,20,25,35,45],
                  "cTime":[23],
                  "cResource":[350,675,1015,1400,30 * 60],
                  "cStorage":[15],
                  "bucket":[30],
                  "targetGroup":[3]
               }
            ...
            "C4":{
               ...
               "trainingCosts":[[32000,28800],[64000,43200],[96000,64800],[128000,86400]],
               "props":{
                  "speed":[1.3],
                  "health":[200,200,200,200,220],
                  "damage":[5 * 60,330,380,430,470],
                  "cTime":[100,100,100,100,90],
                  "cResource":[25 * 60,2250,3375,80 * 60,2 * 60 * 60],
                  "cStorage":[20],
                  "bucket":[30],
                  "targetGroup":[1]
               }
            ...
            "C5":{
               ...
               "trainingCosts":[[64000,18000],[128000,25200],[192000,43200],[384000,86400]],
               "props":{
                  "speed":[2,2.2,2.4,2.6,2.8],
                  "health":[10 * 60,15 * 60,20 * 60,1600,2000],
                  "damage":[0xfa0,0x1f40,200 * 60,16000,20000],
                  "cTime":[25 * 60],
                  "cResource":[5000,250 * 60,500 * 60,750 * 60,60 * 1000],
                  "cStorage":[60],
                  "bucket":[100],
                  "targetGroup":[2],
                  "explode":[1]
            ...
            "C6":{
               ...
               "trainingCosts":[[128000,43200],[256000,64800],[409600,86400],[640000,172800]],
               "props":{
                  "speed":[1.2],
                  "health":[2000,35 * 60,2200,2300,2500],
                  "damage":[50,60,70,80,95],
                  "cTime":[100,100,90],
                  "cResource":[5000,5625,8440,11200,16000],
                  "cStorage":[20],
                  "bucket":[20],
                  "targetGroup":[4]
               }
            ...
            "C7":{
               ...
               "trainingCosts":[[256000,43200],[512000,57600],[210 * 60 * 60,86400],[0xfa000,129600]],
               "props":{
                  "speed":[1],
                  "health":[500,550,10 * 60,650,750],
                  "damage":[200,250,5 * 60,350,400],
                  "cTime":[225,225,225,225,3 * 60],
                  "cResource":[2500,75 * 60,6750,8750,11200],
                  "cStorage":[20],
                  "bucket":[20],
                  "targetGroup":[1]
               }
            ...
            "C8":{
               ...
               "trainingCosts":[[512000,43200],[512000,57600],[210 * 60 * 60,86400],[0xfa000,129600]],
               "props":{
                  "speed":[1.1,1.2,1.3,1.4,1.5],
                  "health":[400],
                  "damage":[10 * 60,10 * 60,620,11 * 60,12 * 60],
                  "cTime":[450,350,250,225,195],
                  "cResource":[5 * 60 * 60,450 * 60,675 * 60,60500,80000],
                  "cStorage":[30],
                  "bucket":[30],
                  "targetGroup":[1]
               }
            ...
            "C9":{
               ...
               "trainingCosts":[[0xfa000,43200],[0x1f5f40,57600],[2870000,72000],[4500000,144000]],
               "props":{
                  "speed":[2,2,2,2,2.1],
                  "health":[10 * 60,700,750,800,1100],
                  "damage":[100,100,200,250,5 * 60],
                  "cTime":[342],
                  "cResource":[200 * 60,20250,30375,35000,50000],
                  "cStorage":[30],
                  "bucket":[30],
                  "targetGroup":[3]
               }
            ...
            "C10":{
               ...
               "trainingCosts":[[0x1f4000,43200],[50 * 60 * 1000,64800],[4400000,86400],[100 * 60 * 1000,172800]],
               "props":{
                  "speed":[1,1,1,1.2,1.4],
                  "health":[0xfa0,0xfa0,4300,4400,4600],
                  "damage":[100,2 * 60,130,140,150],
                  "cTime":[750],
                  "cResource":[500 * 60,750 * 60,67500,75000,25 * 60 * 60],
                  "cStorage":[40],
                  "bucket":[40],
                  "targetGroup":[4]
               }
            ...
            "C11":{
               ...
               "trainingCosts":[[4096000,86400],[7000000,129600],[200 * 60 * 1000,172800],[5 * 60 * 60 * 1000,345600]],
               "props":{
                  "speed":[0.9,0.9,1,1.2,1.2],
                  "health":[800,15 * 60,950,1000,1100],
                  "damage":[20 * 60,1400,1600,30 * 60,2000],
                  "cTime":[1384],
                  "cResource":[60 * 1000,25 * 60 * 60,135000,50 * 60 * 60,65 * 60 * 60],
                  "cStorage":[70],
                  "bucket":[70],
                  "targetGroup":[4]
               }
            ...
            "C12":{
               ...
               "trainingCosts":[[8192000,172800],[10000000,259200],[12200000,345600],[320 * 60 * 1000,518400]],
               "props":{
                  "speed":[0.8,0.85,0.9,1,1.1],
                  "health":[0x1f40,9100,10000,200 * 60,275 * 60],
                  "damage":[25 * 60,25 * 60,1600,1700,30 * 60],
                  "cTime":[60 * 60],
                  "cResource":[150000,225000,337500,440000,10 * 60 * 1000],
                  "cStorage":[160],
                  "bucket":[160],
                  "targetGroup":[1]
               }
            ...
            "C13":{
               ...
               "trainingCosts":[[4096000,86400],[8192000,172800],[8192000,259200],[8192000,345600]],
               "movement":"burrow",
               "pathing":"direct",
               "props":{
                  "speed":[3,4],
                  "health":[10 * 60,800,1100,1300,25 * 60],
                  "damage":[5 * 60,400,550,10 * 60,650],
                  "cTime":[1384],
                  "cResource":[20000,25000,500 * 60,35000,40000],
                  "cStorage":[70],
                  "bucket":[70],
                  "targetGroup":[1]
               }
            ...
            "C14":{
               ...
               "trainingCosts":[[4096000,129600],[7000000,194400],[10000000,288000],[16000000,489600]],
               "movement":"fly",
               "pathing":"direct",
               "props":{
                  "speed":[2.5,2.75,3,3.25,3.5],
                  "health":[1600,1900,40 * 60,50 * 60,60 * 60],
                  "damage":[5 * 60,350,400,500,10 * 60],
                  "cTime":[30 * 60,32 * 60,34 * 60,36 * 60,38 * 60],
                  "cResource":[70000,95000,145000,200000,5 * 60 * 1000],
                  "cStorage":[70],
                  "bucket":[70],
                  "targetGroup":[1]
               }
